    ...
    <section className="bg-[#1c2b3a] text-white py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
          ...
          <br />
          <span className="text-[#e8813a]">for the High Desert</span>
        </h1>
        <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          PJ Site Services helps property owners, contractors, fleet operators,
          boat/RV owners, and commercial sites keep their space clean,
          organized, maintained, and ready to work.
        </p>
        ...
        <p className="text-sm text-gray-400">
          Serving High Desert customers with practical, no-nonsense site support.
        </p>
      </div>
    </section>
  );
